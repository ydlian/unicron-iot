...
@Slf4j
public class CMD_21 implements BaseCMD<CleanRequest_21> {

    // 默认为查询时长度
    private static final int BODY_LENGTH = 164;
    private static final int CMD_NO = 21;
    @Override
    public byte[] getPayload(CleanRequest_21 cleanRequest_21,MqttNetMsgBase base) {
		...
		*/
        ...
        String equipmentId = cleanRequest_21.getEquipmentId();
        byte[] cardNumBytes;
        try {
            ...
            String clean_no = cleanRequest_21.getClean_no();
	...
	@Override
	public String pack(CleanRequest_21 t,MqttNetMsgBase base) {
		// TODO Auto-generated method stub
