 ...
 */
@Slf4j
public class CMD_1303 implements BaseCMD<PolicyQuery_1303> {

    private static final int BODY_LENGTH = 193;
    private static final int CMD_NO = 1303;
    
    private static final String POLICT_TYPE_SET = "1";

    private static final String POLICT_TYPE_QUERY = "0";
    @Override
    public byte[] getPayload(PolicyQuery_1303 policyQuery_1303,MqttNetMsgBase base) {
        ...
        */
        ...
        //类型 0-查询 1-设置
        String policyType = policyQuery_1303.getPolicyType();
        ...
        if(POLICT_TYPE_SET.equals(policyType)){
            ...
            List<String> policyInfos = policyQuery_1303.getDurPrices();
            if (policyInfos != null && policyInfos.size() > 0) {
                for (int i = 0; i < 48; i++) {
                    ...
                    System.arraycopy(durPriceByte, 0, data, 9 + 4 * i+bytesOffset, 4);
                }
            }
        }
	...
	@Override
	public String pack(PolicyQuery_1303 t,MqttNetMsgBase base) {
