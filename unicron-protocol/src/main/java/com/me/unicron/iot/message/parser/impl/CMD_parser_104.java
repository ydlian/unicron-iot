...
@Slf4j
public class CMD_parser_104 implements BaseParser {
	public static final int CMD_NO = 104;

	public StationStatInfoResponse_104 unpack(String version,byte[] dataByte) {
		...
		try {
			...
			if(version.compareTo("01011302")<0){
				//桩端bug 修正数据
				resp.setBms_need_current(EncodeUtil.byteToShort(bms_need_current)/10 + "");
    		}else{
